    ...
    <section className="ebook-section">
      ...
      <div className="ebook-cards">
        <div className="ebook-card">
          ...
          <a href="https://suelirepulho.kpages.online/pagina-de-vendas-f22be18b-8ee3-4ef5-b904-802fb6ad330e" target="_blank" rel="noopener noreferrer" className="ebook-btn">Baixar Ebook Gratuito</a>
        </div>
        ...
        <div className="ebook-card">
          ...
          <a href="https://suelirepulho.kpages.online/virando-a-pagina-apos-o-luto-b358f6ac-5d8b-406e-b2d3-5e431b2231a8" target="_blank" rel="noopener noreferrer" className="ebook-btn">Baixar Ebook Gratuito</a>
        </div>
        ...
        <div className="ebook-card">
          ...
          <a href="https://mentoria.suelirepulho.com.br/processoraja/" target="_blank" rel="noopener noreferrer" className="ebook-btn">Baixar Ebook Gratuito</a>
        </div>
      </div>
